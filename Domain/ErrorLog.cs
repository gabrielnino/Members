...
namespace Domain
{
    ...
    public class ErrorLog(string id) : Entity(id)
    {
        ...
        [MaxLength(150, ErrorMessage = "Level must be maximun 100 characters long.")]
        ...
        [MaxLength(150, ErrorMessage = "Message must be maximun 100 characters long.")]
        ...
        [MaxLength(150, ErrorMessage = "ExceptionType must be maximun 100 characters long.")]
        ...
        [MaxLength(150, ErrorMessage = "StackTrace must be maximun 100 characters long.")]
        public string? StackTrace { get; set; }

        [Required(ErrorMessage = "Context is required.")]
        [MinLength(5, ErrorMessage = "Context must be at least 3 characters long.")]
        [MaxLength(150, ErrorMessage = "Context must be maximun 100 characters long.")]
